...
function useDocsSearch(client, locale, tag, delayMs = 100, allowEmpty = false, key) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$chunk$2d$ORHEEQVY$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOnChange"])(key ?? [
        client,
        debouncedValue,
        locale,
        tag
        ...
        "useDocsSearch.useOnChange": ()=>{
            ...
            async function run() {
                ...
                if (client.type === "fetch") {
                    const { fetchDocs } = await __turbopack_context__.r("[project]/node_modules/fumadocs-core/dist/fetch-W5EHIBOE.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
                    return fetchDocs(debouncedValue, locale, tag, client);
                }
                if (client.type === "algolia") {
                    const { index, type: _, ...rest } = client;
                    const { searchDocs } = await __turbopack_context__.r("[project]/node_modules/fumadocs-core/dist/algolia-NTWLS6J3.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
                    return searchDocs(index, debouncedValue, tag, rest);
                }
                if (client.type === "orama-cloud") {
                    const { searchDocs } = await __turbopack_context__.r("[project]/node_modules/fumadocs-core/dist/orama-cloud-USLSOSXS.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
                    return searchDocs(debouncedValue, tag, client);
                }
                const { createStaticClient } = await __turbopack_context__.r("[project]/node_modules/fumadocs-core/dist/static-VESU2S64.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
...
function SearchDialog({ open, onOpenChange, footer, links = [], search, onSearchChange, isLoading, ...props }) {
    ...
    const defaultItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchDialog.useMemo[defaultItems]": ()=>links.map({
                "SearchDialog.useMemo[defaultItems]": ([name, link])=>({
                        type: 'page',
                        id: name,
                        content: name,
                        url: link
                    })
            }["SearchDialog.useMemo[defaultItems]"])
    }["SearchDialog.useMemo[defaultItems]"], [
        links
    ]);
        ...
        children: [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$dialog$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                ...
                children: [
                    ...
                    props.results !== 'empty' || defaultItems.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(SearchResults, {
                        items: props.results === 'empty' ? defaultItems : props.results,
                        onSelect: ()=>onOpenChange(false)
                    }) : null,
                    footer ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
...
function SearchResults({ items, onSelect, ...props }) {
    ...
    const sidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$ui$2f$dist$2f$contexts$2f$sidebar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSidebar"])();
    ...
    const onKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$utils$2f$use$2d$effect$2d$event$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffectEvent"])({
        "SearchResults.useEffectEvent[onKey]": (e)=>{
            if (e.key === 'ArrowDown' || e.key == 'ArrowUp') {
                setActive({
                    "SearchResults.useEffectEvent[onKey]": (cur)=>{
                        const idx = items.findIndex({
                            "SearchResults.useEffectEvent[onKey].idx": (item)=>item.id === cur
                        }["SearchResults.useEffectEvent[onKey].idx"]);
                        if (idx === -1) return items.at(0)?.id;
                        return items.at((e.key === 'ArrowDown' ? idx + 1 : idx - 1) % items.length)?.id;
                    }
                }["SearchResults.useEffectEvent[onKey]"]);
                e.preventDefault();
            }
            if (e.key === 'Enter') {
                const selected = items.find({
                    "SearchResults.useEffectEvent[onKey].selected": (item)=>item.id === active
                }["SearchResults.useEffectEvent[onKey].selected"]);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
        ...props,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__twMerge__as__cn$3e$__["cn"])('flex max-h-[460px] flex-col overflow-y-auto border-t p-2', props.className),
        children: [
            items.length === 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
                className: "py-12 text-center text-sm",
                children: text.searchNoResult
            }) : null,
            items.map((item)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(CommandItem, {
                    value: item.id,
                    active: active,
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
        ...
        children: [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$ui$2f$dist$2f$icons$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoaderCircle"], {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__twMerge__as__cn$3e$__["cn"])('absolute size-full animate-spin text-fd-primary transition-opacity', !isLoading && 'opacity-0')
            }),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$ui$2f$dist$2f$icons$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Search"], {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__twMerge__as__cn$3e$__["cn"])('absolute size-full text-fd-muted-foreground transition-opacity', isLoading && 'opacity-0')
            })
        ]
    });
}
function CommandItem({ active, onActiveChange, value, ...props }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("button", {
        ref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
            "CommandItem.useCallback": (element)=>{
...
function TagsList({ tag, onTagChange, items, allowClear, ...props }) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
        ...props,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tailwind$2d$merge$2f$dist$2f$bundle$2d$mjs$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__twMerge__as__cn$3e$__["cn"])('flex flex-row items-center gap-1 flex-wrap', props.className),
        children: [
            items.map((item)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("button", {
                    type: "button",
...
function DefaultSearchDialog({ defaultTag, tags, api, delayMs, type = 'fetch', allowClear = false, ...props }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$chunk$2d$ORHEEQVY$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOnChange"])(defaultTag, {
...
//# sourceMappingURL=node_modules_064b1ca3._.js.map