...
- `gpu_type` (str, optional): The type of GPU to use. Defaults to "H100"
- `n_gpus` (int, optional): The number of GPUs. Defaults to 8
- `lora_rank` (int, optional): The LoRA rank. Defaults to 0
- `max_seq_length` (int, optional): Maximum sequence length. Defaults to 1024
- `epochs` (int, optional): Number of training epochs. Defaults to 1
- `learning_rate` (float, optional): Learning rate. Defaults to 5e-6
- `adam_beta1` (float, optional): Adam beta1 parameter
- `adam_beta2` (float, optional): Adam beta2 parameter
- `weight_decay` (float, optional): Weight decay
- `warmup_ratio` (float, optional): Warmup ratio
- `kl_beta` (float, optional): KL beta parameter
- `hf_token` (str, optional): Hugging Face token
- `turbo` (bool, optional): Whether to use turbo mode. Defaults to True
