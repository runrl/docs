...
Next, select "Qwen 3 4B" as the base model:
...
Now, we need to create a prompt file. A prompt file is a jsonl, which takes on the following format, e.g.:
