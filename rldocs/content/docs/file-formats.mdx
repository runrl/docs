...
**Reward Function vs. Environment**: Choose the reward function if you only need single step interactions. Choose the environment class if you need multistep interactions with tool calling or feedback.
