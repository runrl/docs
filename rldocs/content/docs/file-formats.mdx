...
This guide explains the file formats used by RunRL for training reinforcement learning models.
...
- Test your JSONL file with a JSON validator to ensure proper formatting
...
A reward function:
- Receives the model's completion/response
- Evaluates the quality of that response
- Returns a numerical reward score
- Can access additional data from the prompt file (like expected answers)
...
- [Python Implementation Guide](/docs/python/file-formats#reward-functions)
...
For language-specific implementation details, see:
- [Python Implementation Guide](/docs/python/file-formats#environment-classes)

## General Best Practices

### For All File Types
- Test your files thoroughly before starting training runs
