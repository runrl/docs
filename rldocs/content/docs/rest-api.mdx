...
description: Complete reference for the RunRL REST API v1
---
...
```
https://agi.motte.ai/api/v1
```

## Authentication

All API requests require authentication using an API key. Create your API key in **Settings → API Keys**.
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/health
```
...
curl -X POST \
  ...
  https://agi.motte.ai/api/v1/keys
```
...
# List all files
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/files

# Filter by type
curl -H "Authorization: Bearer YOUR_API_KEY" \
     "https://agi.motte.ai/api/v1/files?type=prompt"

# Search and pagination
curl -H "Authorization: Bearer YOUR_API_KEY" \
     "https://agi.motte.ai/api/v1/files?search=my_file&page=1&per_page=20"
```
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/files/abc123-uuid
```
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/files/abc123-uuid/download \
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/files/abc123-uuid/content
```
...
# List all runs
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/runs

# Filter by status
curl -H "Authorization: Bearer YOUR_API_KEY" \
     "https://agi.motte.ai/api/v1/runs?status=RUNNING"

# Date range and pagination
curl -H "Authorization: Bearer YOUR_API_KEY" \
     "https://agi.motte.ai/api/v1/runs?created_after=2025-01-01&page=1&per_page=10"
```
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/runs/123
```
...
curl -X POST \
  -H "Authorization: Bearer YOUR_API_KEY" \
  https://agi.motte.ai/api/v1/runs/123/cancel
```
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/runs/123/history
```
...
```bash
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://agi.motte.ai/api/v1/runs/123/metrics
```
...
```json
{
  ...
  "details": { ... },
  "docs": "https://docs.motte.ai/api/scopes"
}
```
...
BASE_URL = "https://agi.motte.ai/api/v1"
...
class RunRL implements RunRLClient {
  constructor(public apiKey: string, public baseURL = 'https://agi.motte.ai/api/v1') {}
