...
For details on prompt file format requirements, see the [File Formats](/docs/file-formats#prompt-files) documentation.
...
For details on reward function format requirements, see the [File Formats](/docs/file-formats#reward-functions) documentation.
...
For details on the hyperparameters used when creating a run, see the [API Reference](/docs/api-reference#create_run) documentation.
