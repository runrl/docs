...
description: How to set up your Motte.ai account and prepare for training
---

# Getting Started

Get your Motte.ai account ready for reinforcement learning training runs.

## Account Setup

### 1. Sign Up & Verification

1. **Visit [Motte.ai](https://motte.ai)** and click "Sign Up"
...
1. **Navigate to [Settings > Billing](https://motte.ai/settings/billing)**
...
- Ensure valid JSON on each line

### "Model not found"
**Solution**:
- Check model name spelling
- Ensure model exists on HuggingFace
- Try popular models like "meta-llama/Llama-2-7b-chat-hf"

## Next Steps

Once your account is set up:

1. **Read [Creating Your First Run](/docs/authentication)** for step-by-step guidance
2. **Review [File Formats](/docs/file-formats)** to prepare your data
3. **Check [Examples](/docs/examples)** for inspiration and templates

Ready to start training? [Create your first run now!](https://motte.ai/runs/create)
