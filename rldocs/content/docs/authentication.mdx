...
description: Complete walkthrough for launching your first training run on Motte.ai
---
...
Ensure you have completed [account setup](/docs/installation) including:
...
1. **Go to [Create Run](https://motte.ai/runs/create)**
...
4. **Read [Examples](/docs/examples)** for advanced techniques

## Need Help?

- **Search the docs** using Cmd/Ctrl+K
- **Check [Troubleshooting](/docs/troubleshooting)** for common issues  
- **Review [Examples](/docs/examples)** for working templates
- **Monitor [Dashboard](https://motte.ai/dashboard)** for system status

Ready to create your first run? [Launch now!](https://motte.ai/runs/create)
